...
@SpringBootTest // 통합테스트, 스프링 컨테이너를 생성해서 테스트 코드가 들어갑니다.
    // 만약 단위 테스트를 진행하고 싶은 경우는 Mock객체를 만들어서 수행합니다.
class InventoryServiceTest {
    ...
    @AfterEach // 테스트 수행 후 DB를 초기화(비워버리기)
    public void delete(){
